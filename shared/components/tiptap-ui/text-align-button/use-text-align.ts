...
// --- Icons ---
import { AlignCenterIcon } from "@/shared/components/tiptap-icons/align-center-icon";
import { AlignJustifyIcon } from "@/shared/components/tiptap-icons/align-justify-icon";
import { AlignLeftIcon } from "@/shared/components/tiptap-icons/align-left-icon";
import { AlignRightIcon } from "@/shared/components/tiptap-icons/align-right-icon";
